...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"ytmusic" | "lastfm">("ytmusic");
  const lastfmConnected = useLastfmStatus(token);
  ...
  const handleTabChange = (tab: "ytmusic" | "lastfm") => {
    setActiveTab(tab);
        ...
        {activeTab === "lastfm" ? (
          ...
          extensionInstalled ? (
            ...
            <div className="flex flex-col gap-8 items-center justify-center py-16">
              ...
              <a
                href="https://chromewebstore.google.com/detail/ksmusic/pjjehmaallfipoebeccmbjdlgbbocjba"
