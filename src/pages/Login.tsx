export default function Login() {
    return (
        <div className="px-40 flex items-center justify-center min-h-screen">
            <div className="bg-zinc-800 flex items-center justify-center border-purple-400 shadow-2xl border rounded-2xl h-128">
                <a href="/" className="flex items-center justify-center w-full h-full px-24 gap-1">
